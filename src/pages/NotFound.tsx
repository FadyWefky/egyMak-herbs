  ...
  return (
    ...
    >
      <div className="mac-panel max-w-md w-full p-10 text-center">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center rounded-[10px] bg-primary px-6 py-3 text-primary-foreground font-semibold hover:bg-primary/90 transition-colors"
        >
          {t('notFound.homeLink')}
        </Link>
      </div>
